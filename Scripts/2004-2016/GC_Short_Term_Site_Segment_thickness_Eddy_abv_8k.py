...
with PdfPages(r'C:\workspace\Time_Series\Output\2004-2015\GC_short_Term_thickness_eddyabv8k_w_err_bars.pdf') as pdf:
    fig, ax = plt.subplots(figsize=(7,6),nrows=1)
    table1.plot(y = 'thickness', yerr = 'std_error', ax = ax, label = 'Eastern Grand Canyon')
    #table2.plot(y = 'thickness', yerr = 'std_error', ax = ax, label = 'Central Grand Canyon')
    table3.plot(y = 'thickness', yerr = 'std_error', ax = ax, label = 'Western Grand Canyon')
