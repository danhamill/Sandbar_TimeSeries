...
del temp, tmp_pvt, tmp_count
with PdfPages(r'C:\workspace\Time_Series\Output\2004-2015\MC_short_Term_thickness_eddyabv8k_w_err_bars.pdf') as pdf:
    ...
    ax.set_title('ShortTerm Monitoring Sites: Eddy Above 8k')   
    pdf.savefig()
    plt.close()
del pdf
