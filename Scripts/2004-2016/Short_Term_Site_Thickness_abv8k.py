...
query1 = query1[query1['TripDate']>'2004-01-01']            #Drop all surveys before they were officially monitored
...
plot_counter = 0
site_counter =0
with PdfPages(r'C:\workspace\Time_Series\Output\Short_Term_Site_Thickness_2004.pdf') as pdf:
    print 'pdf open'
    for i in list1:
