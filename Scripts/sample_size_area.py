...
r = df['All Sites N=22'].plot.box(ax=ax2, showfliers=False,return_type='dict')
x = np.random.normal(1,0.04,len(df_all[df_all[0] == 'r']['All Sites N=22']))
ax2.plot(x,df_all[df_all[0] == 'r']['All Sites N=22'],marker='*',lw=0,label='Reattachment: N=12',markersize=8,c='y',alpha=0.4)
x = np.random.normal(1,0.04,len(df_all[df_all[0] == 's']['All Sites N=22']))
ax2.plot(x,df_all[df_all[0] == 's']['All Sites N=22'],marker='d',lw=0,label='Separation: N=8',markersize=8,alpha=0.4)
x = np.random.normal(1,0.04,len(df_all[df_all[0] == 'u']['All Sites N=22']))
ax2.plot(x,df_all[df_all[0] == 'u']['All Sites N=22'],marker='o',lw=0,label='Undifferientated: N=4',markersize=8,alpha=0.4)
legend = ax2.legend(loc=2,title='C',prop=fontP,numpoints=1)
ax2.set_ylim(0,40000)


r1 = df['Long Term Sites: N=12'].plot.box(ax=ax,sharey=ax, showfliers=False,return_type='dict')

x = np.random.normal(1,0.04,len(df_old[df_old['Bar Type'] == 'r']['Area']))
ax.plot(x,df_old[df_old['Bar Type'] == 'r']['Area'],marker='*',lw=0,label='Reattachment: N=7',markersize=8,c='y',alpha=0.4)

x = np.random.normal(1,0.04,len(df_old[df_old['Bar Type'] == 's']['Area']))
ax.plot(x,df_old[df_old['Bar Type'] == 's']['Area'],marker='d',lw=0,label='Separation: N=6',markersize=8,alpha=0.4)

x = np.random.normal(1,0.04,len(df_old[df_old['Bar Type'] == 'u']['Area']))
ax.plot(x,df_old[df_old['Bar Type'] == 'u']['Area'],marker='o',lw=0,label='Undifferientated: N=1',markersize=8,alpha=0.4)
legend1 = ax.legend(loc=2,title='A',prop=fontP,numpoints=1)

r2 = df['Additional Sites N=10'].plot.box(ax=ax1,sharey=ax, showfliers=False,return_type='dict')
x = np.random.normal(1,0.04,len(df_new[df_new['Bar Type'] == 'r']['Area']))
ax1.plot(x,df_new[df_new['Bar Type'] == 'r']['Area'],marker='*',lw=0,label='Reattachment: N=5',markersize=8,c='y',alpha=0.4)
x = np.random.normal(1,0.04,len(df_new[df_new['Bar Type'] == 's']['Area']))
ax1.plot(x,df_new[df_new['Bar Type'] == 's']['Area'],marker='d',lw=0,label='Separation: N=2',markersize=8,alpha=0.4)
x = np.random.normal(1,0.04,len(df_new[df_new['Bar Type'] == 'u']['Area']))
ax1.plot(x,df_new[df_new['Bar Type'] == 'u']['Area'],marker='o',lw=0,label='Undifferientated: N=3',markersize=8,alpha=0.4)
legend2 = ax1.legend(loc=2,title='B',prop=fontP,numpoints=1)
