...
if __name__ =='__main__':
    ...
    g_1b = np.array(['123l','172l','044l','044l','183r','220r','050r','065r','047r'])  #'009l' dropped because it was added in 2008,-'045l' dropped 045L because sep and reatt bar wasnt surveyed each time
    ...
    for group1 in [g_1a,g_1b,g_1c,g_2,g_3,g_4]:
        ...
        temp = subset[(subset['TripDate']<'2003-09-20') & (subset['Site'].isin(set(lu_sites['Sediment Deficit Sites'])))]
        later = subset[(subset['TripDate']>='2003-09-20')]
        
        subset = pd.concat([temp,later])
