...
mc_norm_area, mc_norm_area_tbl_deficit = area_norm_data(mc)
gc_norm_area, gc_norm_area_tbl_deficit = area_norm_data(gc)


mc_norm_vol, mc_norm_vol_tbl_deficit = vol_norm_data(mc)
gc_norm_vol, gc_norm_vol_tbl_deficit = vol_norm_data(gc)
...
ax1.set_xlim(pd.Timestamp('1990-01-01'),  pd.Timestamp('2004-01-01'))
...
plt.tight_layout()
plt.savefig(out_root + os.sep + "All_sites_sediment_deficit_norm_volume_above_8k.png",dpi=600)
