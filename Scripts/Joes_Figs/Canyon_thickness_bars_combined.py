...
subset = data[(data.Time_Series == 'long') & (data.Site !='m006r')& (data.Site !='062r') & 
               (data.Site !='068r') & (data.Site !='167l') & (data.SitePart == 'Eddy') & 
              (data.Plane_Height != 'eddyminto8k') ] 

#Combine sep and reatt bars at two bar sites
subset = subset[ (subset.Site.str.len() < 5)]  
...
subset1 = data[(data.Time_Series == 'long') & (data.Site !='m006r')& (data.Site !='062r')& (data.Site !='068r') & 
              (data.Site !='167l') & (data.SitePart == 'Eddy') & (data.Plane_Height != 'eddyminto8k') & (data.Site.str.len() <5)]   
...
plt.tight_layout()
plt.savefig(out_root + os.sep + 'Canyon_Thickness_Changes_bars_Combined_mergeMaxArea.png')
...
writer = pd.ExcelWriter(out_root + os.sep + "canyon_thickness_tow_combined_mergeMaxArea.xlsx",engine='xlsxwriter')
