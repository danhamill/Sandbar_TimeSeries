...
plot_counter = 0
site_counter =0
with PdfPages(r'C:\workspace\Time_Series\Output\Long_Term_Site_norm_vol_all.pdf') as pdf:
    print 'pdf open'
    for i in list1:
        if site_counter == 0:                                   #This is the first run       
            ...
            if plot_counter == 0:               #This is the first plot on a page
                ...
                if plot_counter % 3 == 0:
                    ...
                    plot_counter += 2
        site_counter += 1         
del pdf, table1, table2, table3, merge1, query1, n, site_counter, plot_counter
