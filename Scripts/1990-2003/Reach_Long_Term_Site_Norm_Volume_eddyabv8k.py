...
with PdfPages(r'C:\workspace\Time_Series\Output\2004-2015\Reach_Long_Term_Normalized_Volume_1990.pdf') as pdf:
    fig, ax = plt.subplots(figsize=(7,3),nrows=1)
    table1.plot(y = 'NormVol', ax = ax, label = 'Marble Canyon',ylim=(0,1.1), marker = 'o')
    table2.plot(y = 'NormVol', ax = ax, label = 'Grand Canyon',ylim=(0,1.1), marker = 'o')
