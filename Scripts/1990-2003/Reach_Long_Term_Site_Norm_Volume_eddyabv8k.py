...
(data.SitePart == 'Eddy') & (data.Plane_Height != 'eddyminto8k') & (data.SiteRange=='long') & (data.Time_Series == 'long')]
...
with PdfPages(r'C:\workspace\Time_Series\Output\1990-2003\Reach_Long_Term_Normalized_Volume_w_error_bars_1990.pdf') as pdf:
