...
with PdfPages(r'C:\workspace\Time_Series\Output\Reach_Long_Term_Normalized_Volume_abv25k.pdf') as pdf:
    ...
    ax.set_title('Long Term Monitoring Sites: eddy above 25k')   
    pdf.savefig()
    plt.close()
del pdf
