...
ax.set_xlabel('Date')
plt.tight_layout()
plt.savefig(r"C:\workspace\Time_Series\Output\sediment_deficit_area.png",dpi=600)
...
ax1.set_xlabel('Date')
plt.tight_layout()
plt.savefig(r"C:\workspace\Time_Series\Output\sediment_enrichment_area.png",dpi=600)
